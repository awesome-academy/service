                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($role as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ url('/admin/role/' . $item->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> {{ __('show') }}</button></a>
                                            <a href="{{ url('/admin/role/' . $item->id . '/edit') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> {{ __('edit') }}</button></a>
                                            {{ Form::open([
                                                'method' => 'DELETE',
